...
$TARGET_EMAIL = array(EMAIL_NAME."@ifworld\.com$", 
					EMAIL_NAME."@yahoo\.com$");

            /* Help: http://www.tectite.com/fmdoc/def_alert.php */
define("DEF_ALERT","damon@ifworld.com");
...
$FIXED_SENDER = "contact@executiveaviation.net";
...
$LOGDIR = "form_logs";                           // directory for log files; empty string to
                                        // disallow log files
...
$TEMPLATEDIR = "/var/www/executiveaviation/templates";                  // directory for template files; empty string
